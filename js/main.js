...
(function () {
  ...
  if (marqueeInner) {
    const items = [
      'Serigrafía', 'Sublimación', 'Corte de Vinil',
      'Lona Publicitaria', 'Micro Perforado', 'Vinil Adhesivo',
      'Fabricación de Mochilas', 'Marcos con Calidad Fotográfica',
      'Bolsas Publicitarias', 'Envíos a Todo México'
    ];
  ...
  if (form) {
    form.addEventListener('submit', (e) => {
      ...
      const phone = '525547240835';
      const text  = encodeURIComponent(
        `Hola Estampando Tus Sueños 🎨\n\nSoy *${name}*.\nMe interesa: *${interest}*.\n\n${message}`
      );
